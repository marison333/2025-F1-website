...
import { InViewAnimation } from '../animation';
...
export const DriverCard = ({ driver, className }: DriverCardProps) => {
    ...
    return (
        <InViewAnimation>
            <Link data-slot='driver-card' href={driverLink}>
                <Card
                    className={`dark relative z-0 group h-56 w-full min-w-[300px] text-white ${getTeamBackgroundColorDark(driver.team.id)} overflow-hidden ${className}`}>
