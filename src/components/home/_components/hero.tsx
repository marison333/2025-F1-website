...
export default function Hero() {
    return (
        <div
            className='relative w-full mx-auto flex flex-wrap md:grid md:grid-cols-2 gap-2 [&>*]:border-zinc-950'
            data-slot='hero'>
            {heroItems.map((item, index) => (
                <Link key={item.href} href={item.href}>
                    <Card className='relative dark h-[40vh] w-full md:h-[55vh] md:w-full mx-auto flex col-span-1 overflow-hidden'>
                        <Image
