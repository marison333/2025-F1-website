...
export function PodiumCards({ option, position }: PodiumCardProps) {
            ...
            <InView
                ...
                <Link
                    className={clsx(
                        ...
                        position === 'first' && 'h-52 md:h-80 md:order-2',
                        position === 'second' && 'h-50 md:h-74 md:order-1',
                        position === 'third' && 'h-50 md:h-68 md:order-3'
                    )}
                    href={`/drivers/${driver.givenName.toLowerCase()}-${driver.familyName.toLowerCase()}`}>
                    <span className='absolute size-84 -bottom-3 -left-25 opacity-70'>
                        <span
                            ...
                            <span className='flex flex-col gap-2'>
                                <span>
                                    ...
                                    <span className='mb-3 flex-col gap-1 justify-items-start'>
                                        ...
                                        <span className='relative w-max text-sm uppercase'>
            ...
            <InView
                ...
                <Link
                    className={clsx(
                        ...
                        position === 'first' && 'h-78',
                        position === 'second' && 'h-72',
                        position === 'third' && 'h-68'
                    )}
                    href={`/teams/${team.id}`}>
                    <span className='absolute -z-10 h-24 -bottom-0.5 -left-20 lg:right-0 opacity-70'>
                        <span
    ...
    return (
        <Card
            ...
            className={clsx(
                `relative z-10 size-full *:w-full text-white bg-liniear-to-l ${teamGradientColor(teamId)}  ${darkTeamGradientColor(teamId)} overflow-hidden`,
