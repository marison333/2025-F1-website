...
import { getDriverStatistics } from '@/lib/data/driver-statistics';
...
export default async function DriverPage({ params }: DriverPageProps) {
    ...
    const statistics = await getDriverStatistics(driver);

    return <DriverProfile driver={driver} stats={statistics} />;
}
